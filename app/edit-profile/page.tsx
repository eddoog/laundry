                  ...
                  {user?.role === 'PENGELOLA_LAUNDRY' && (
                    <div className="flex justify-between w-full">
                      <div className="flex flex-col gap-1">
                        <h1 className="text-l font-bold text-muted-foreground">
                          {' '}
                          Service{' '}
                        </h1>
                        ...
                        <div className="flex justify-start gap-2">
                          <Input
                            ...
                            defaultChecked={
                              user?.tags
                                ? user?.tags.includes(Tags.SEPATU)
                                : false
                            }
                            {...register('sepatu')}
                          />
                        ...
                        <div className="flex justify-start gap-2">
                          <Input
                            ...
                            defaultChecked={
                              user?.tags
                                ? user?.tags.includes(Tags.SEPRAI)
                                : false
                            }
                            {...register('seprai')}
                          />
